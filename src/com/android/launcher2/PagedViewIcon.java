...
//change and add by wdr
        mIcon = toNewBitmap(info.iconBitmap);
...
//function add by wdr 2012.10.11
    private Bitmap toNewBitmap(Bitmap srcBitmap){
    	...
    	Bitmap newBitmap = Bitmap.createBitmap(srcBitmap, 0, 0, srcWidth, srcHeight, matrix, true);
